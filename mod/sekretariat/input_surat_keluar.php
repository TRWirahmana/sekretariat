...
<?php	
 ...
 $save_url = "index.php?_mod=$_mod&task=simpan_surat_keluar&act=".$act;
 if ($act=="new" && $jml==0){?>		 
      <SCRIPT language="JavaScript">
       alert('Stock Nomor Habis!');
	   window.history.back();
      </SCRIPT><?php 
 }else{
    if ($act=="edit") {
 ...
 $save_url = "index.php?_mod=$_mod&task=simpan_surat_keluar";
...
<tr><td width="150px" valign="top">Jenis Surat</td><td>
	...
	<tr><td colspan=2>	
	<div id="surat_tugas" style="display:none">
           	<table>	
...
<?php
	...
	<tr><td width="150px" valign="top">Hal</td><td><textarea rows=3 cols=50 name="hal"><?php echo $hal;?></textarea></td></tr>
	</table>	
	
</div>	
<div id="surat_dinas" style="display:none">	
<table>
<tr><td width="110px">Tanggal Surat</td><td><input type="text" name="tgl_surat" value="<?php echo $tgl_surat;?>" size="10"/><script language="JavaScript">
	new tcal ({
		'formname': 'form',
