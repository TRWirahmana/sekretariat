...
<table class=table cellpadding=2 cellspacing=1 width=100%>
    <tr class=\"bodystyle\" bgcolor='#757575' align=center height="3">
        ...
        <td class="table-menu" align="center" valign="top" width="30%"><b>Perihal</b></td>
        <td class="table-menu" align="center" valign="top" width="10%"><b>Tgl Diterima</b></td>
        <td class="table-menu" align="center" valign="top" width="5%"><b>Aksi</b></td></tr>
    <?php
    ...
    while ($row=mysql_fetch_array($rs)){
		...
		<tr bgcolor=$bg>
		    ...
		    <td align=\"left\" valign=\"top\"><p>$no_srt_masuk</p></td>
		    <td valign=\"top\"><p>$tgl_srt</p></td>
		    <td valign=\"top\"><p>$row[5]</p></td>
		    <td valign=\"top\">$row[6]</td>
		    <td valign=\"top\"><p>$tgl_terima</p></td>";?>
        <td valign="top">
            <a href="index.php?_mod=sekretariat&task=detail&id=<?php echo $row[0];?>" title="detail"><img border=0 src="<?php echo $imgdoc;?>"</a></td>
        </tr>
        <?php
        $no++;
    }
