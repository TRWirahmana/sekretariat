...
echo "Jenis Peraturan >> </br></br>";


$send_url = "index.php?_mod=$_mod&task=report_jenis";
?>
<h2 align="center">JENIS PERATURAN</h2>
 <table class=table cellpadding=2 cellspacing=1 bordercolor=#111111 width=100%>
	<tr class=\"bodystyle\" bgcolor='#757575' align=center height="3"><td width="6"><b>No</b></td><td align=center width="85%"><b>Nama Peraturan</b></td><td width="15%"><b>-</b></td></tr>
	<?php
