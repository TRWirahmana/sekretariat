...
$sql = "SELECT * FROM peraturan where (jenis_id BETWEEN 3 AND 7)";
if($key!='' || $jenis!=0){
		$sql .= " WHERE";
	 }	 
	if($key!=''){
	...
	$link = 'index.php?_mod=peraturan&task=report_skb&act=go&key='.$key.'&jenis='.$jenis;
	//echo $page;
	$row_perpage=10;
	$jml=mysql_num_rows(mysql_query($sql));
	$pager = new PS_Pagination($conn,$sql,$row_perpage,5,$link);
	$rs = $pager->paginate();
echo "Cari Kesepakatan >> </br></br>";


$send_url = "index.php?_mod=$_mod&task=report_skb";
?>
<table border=0 width="100%" style="border:1px solid #cccccc"><tr><td>
<form action="<?php echo $send_url;?>" method="post" name="form">
	<table>
		   <tr><td width="150px">Judul/Nomor/Tanggal</td><td><input type="text" name="key" value="" size="35"/></td></tr>
...
echo "<table border=0 width=100%>";
 ...
 <table class=table cellpadding=2 cellspacing=1 bordercolor=#111111 width=100%>
	<tr class=\"bodystyle\" bgcolor='#757575' align=center height="3"><td align="center" width="3"><b>No</b></td><td align="center" width="5"><b>Tanggal</b></td><td align="center" width="10"><b>Jenis</b></td><td align="center" width="10"><b>Nomor</b></td><td align="center" width="50%"><b>Judul Perjanjian</b></td><td align="center" width="50%"><b>Keterangan</b></td><td align="center" width="3">-</td></td></tr>
	<?php
